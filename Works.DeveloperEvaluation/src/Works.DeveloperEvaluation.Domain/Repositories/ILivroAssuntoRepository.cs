...
public interface ILivroAssuntoRepository
{
    ...
    Task<LivroAssunto> CreateAsync(LivroAssunto livroAssunto, CancellationToken cancellationToken = default);
    ...
    Task<LivroAssunto> UpdateAsync(LivroAssunto livroAssunto, CancellationToken cancellationToken = default);
    ...
    Task<LivroAssunto?> GetByIdAsync(int id, CancellationToken cancellationToken = default);

    Task<List<LivroAssunto>?> GetLivrosAsync(CancellationToken cancellationToken = default);
