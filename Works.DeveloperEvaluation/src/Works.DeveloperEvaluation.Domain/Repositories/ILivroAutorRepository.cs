...
public interface ILivroAutorRepository
{
    ...
    Task<LivroAutor> CreateAsync(LivroAutor livroAutor, CancellationToken cancellationToken = default);
    ...
    Task<LivroAutor> UpdateAsync(LivroAutor livroAutor, CancellationToken cancellationToken = default);
    ...
    Task<LivroAutor?> GetByIdAsync(int id, CancellationToken cancellationToken = default);

    Task<List<LivroAutor>?> GetLivrosAsync(CancellationToken cancellationToken = default);
